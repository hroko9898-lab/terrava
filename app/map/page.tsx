...
export default function MapPage() {
  return (
    <main className="min-h-screen bg-[#f3eadb] text-[#3b2416] overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-[#eadcc7] rounded-3xl p-7 border border-[#d6c3aa]">
              ...
              <p className="text-[#6b4b32]">
                Натисни маркер на картата, за да отвориш страницата на
                съответната планина.
              </p>
            </div>
            ...
            <div className="bg-[#eadcc7] rounded-3xl p-7 border border-[#d6c3aa]">
              ...
              <p className="text-[#6b4b32]">
                Превключи към топографска карта, за да видиш релефа и
                планинския терен.
              </p>
            </div>
            ...
            <div className="bg-[#eadcc7] rounded-3xl p-7 border border-[#d6c3aa]">
              ...
              <p className="text-[#6b4b32]">
                Включи слоя с пътеки, за да видиш основните туристически
                маршрути.
              </p>
            </div>
            ...
            <div className="bg-[#eadcc7] rounded-3xl p-7 border border-[#d6c3aa]">
              ...
              <p className="text-[#6b4b32]">
                Използвай бутона „Покажи къде съм“, за да видиш текущото си
                местоположение.
              </p>
            </div>
          </div>
      ...
      <SiteFooter description="Карта за планини, маршрути, терен и GPS ориентация в България." />
    </main>
  );
}
