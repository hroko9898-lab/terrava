export const metadata = {
  title: "Вихрен | Маршрут в Пирин | Terrava",
  description:
    ...
    <main className="min-h-screen bg-[#f3eadb] text-[#3b2416] px-6 py-12 md:px-20 md:py-20">
      ...
      <section className="max-w-5xl mb-16">
        ...
        <p className="text-xl md:text-2xl text-[#6b4b32] leading-relaxed">
          Вихрен е един от най-емблематичните върхове в България. Маршрутът е
          красив, но сериозен — с каменист терен, открити участъци и нужда от
      ...
      <section className="grid md:grid-cols-4 gap-6 mb-20">
        ...
        <div className="bg-[#eadcc7] rounded-3xl p-6 border border-[#d6c3aa]">
          ...
          <p className="text-[#6b4b32]">С кола до хижа Вихрен, ако пътят е отворен</p>
        </div>
      ...
      <section className="grid lg:grid-cols-2 gap-8 mb-20">
        <div className="bg-[#eadcc7] rounded-[2rem] p-8 border border-[#d6c3aa]">
          ...
          <ul className="space-y-4 text-[#6b4b32] text-lg">
            <li>Мраморни върхове и алпийски пейзаж</li>
            <li>Гледки към Пирин и околните била</li>
            <li>Каменист високопланински терен</li>
            <li>Един от най-разпознаваемите върхове в България</li>
          </ul>
        </div>
        ...
        <div className="bg-[#eadcc7] rounded-[2rem] p-8 border border-[#d6c3aa]">
          ...
          <ul className="space-y-4 text-[#6b4b32] text-lg">
            ...
            <li>Сериозно натоварване при изкачване</li>
          </ul>
        </div>
      </section>
      ...
      <section className="bg-[#3b2416] text-[#f3eadb] rounded-[2.5rem] p-8 md:p-12 mb-20">
        ...
        <p className="text-lg text-[#e5d3b8] leading-relaxed max-w-4xl">
          Тръгни рано, провери прогнозата и не подценявай маршрута. Носи вода,
          храна, връхна дреха и удобни обувки. При мъгла, буря или силен вятър
          е по-добре да отложиш изкачването.
        </p>
      </section>
