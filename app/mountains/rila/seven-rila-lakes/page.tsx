export const metadata = {
  title: "Седемте рилски езера | Маршрут в Рила | Terrava",
  description:
    ...
    <main className="min-h-screen bg-[#f3eadb] text-[#3b2416] px-6 py-12 md:px-20 md:py-20">
      ...
      <section className="max-w-5xl mb-16">
        ...
        <p className="text-xl md:text-2xl text-[#6b4b32] leading-relaxed">
          Един от най-популярните маршрути в България. Подходящ е за хора с
          нормална физическа подготовка, но през силен сезон може да бъде много
          посещаван.
        </p>
      </section>
      ...
      <section className="grid md:grid-cols-4 gap-6 mb-20">
        ...
        <div className="bg-[#eadcc7] rounded-3xl p-6 border border-[#d6c3aa]">
          ...
          <p className="text-[#6b4b32]">3–5 часа</p>
        </div>

        <div className="bg-[#eadcc7] rounded-3xl p-6 border border-[#d6c3aa]">
          <h2 className="text-xl font-bold mb-2">Достъп</h2>
          <p className="text-[#6b4b32]">С кола до Паничище / лифта</p>
        </div>

        <div className="bg-[#eadcc7] rounded-3xl p-6 border border-[#d6c3aa]">
          <h2 className="text-xl font-bold mb-2">Подходящо за</h2>
          <p className="text-[#6b4b32]">Начинаещи с подготовка</p>
        </div>
      </section>
      ...
      <section className="grid lg:grid-cols-2 gap-8 mb-20">
        <div className="bg-[#eadcc7] rounded-[2rem] p-8 border border-[#d6c3aa]">
          ...
          <ul className="space-y-4 text-[#6b4b32] text-lg">
            <li>Седемте ледникови езера</li>
            <li>Панорамни гледки към Рила</li>
            <li>Високопланински пейзажи</li>
            <li>Популярни места за снимки</li>
          </ul>
        </div>
        ...
        <div className="bg-[#eadcc7] rounded-[2rem] p-8 border border-[#d6c3aa]">
          ...
          <ul className="space-y-4 text-[#6b4b32] text-lg">
            ...
            <li>Много хора през активния сезон</li>
      ...
      <section className="bg-[#3b2416] text-[#f3eadb] rounded-[2.5rem] p-8 md:p-12 mb-20">
        ...
        <p className="text-lg text-[#e5d3b8] leading-relaxed max-w-4xl">
          Провери прогнозата, носи вода, връхна дреха и удобни обувки. Не
          подценявай маршрута, защото макар да е популярен, теренът е
          високопланински и времето може да се промени бързо.
        </p>
      </section>
