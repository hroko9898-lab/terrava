export const metadata = {
  title: "Връх Ботев | Маршрут в Стара планина | Terrava",
  description:
    ...
    <main className="min-h-screen bg-[#f3eadb] text-[#3b2416] px-6 py-12 md:px-20 md:py-20">
      ...
      <section className="max-w-5xl mb-16">
        ...
        <p className="text-xl md:text-2xl text-[#6b4b32] leading-relaxed">
          Връх Ботев е най-високият връх в Стара планина. Маршрутите към него
          са дълги и сериозни, с открити участъци, променливо време и нужда от
      ...
      <section className="grid md:grid-cols-4 gap-6 mb-20">
        ...
        <div className="bg-[#eadcc7] rounded-3xl p-6 border border-[#d6c3aa]">
          ...
          <p className="text-[#6b4b32]">
            С кола до начална точка според избрания маршрут
          </p>
        </div>
      ...
      <section className="grid lg:grid-cols-2 gap-8 mb-20">
        <div className="bg-[#eadcc7] rounded-[2rem] p-8 border border-[#d6c3aa]">
          ...
          <ul className="space-y-4 text-[#6b4b32] text-lg">
            <li>Най-високият връх в Стара планина</li>
            <li>Дълги билни гледки</li>
            <li>Див старопланински терен</li>
            <li>Възможност за комбиниране с хижи и водопади</li>
          </ul>
        </div>
        ...
        <div className="bg-[#eadcc7] rounded-[2rem] p-8 border border-[#d6c3aa]">
          ...
          <ul className="space-y-4 text-[#6b4b32] text-lg">
            ...
            <li>Силен вятър по билото</li>
            <li>Дълъг преход и умора</li>
            <li>Мъгла и слаба видимост</li>
          </ul>
        </div>
      </section>
      ...
      <section className="bg-[#3b2416] text-[#f3eadb] rounded-[2.5rem] p-8 md:p-12 mb-20">
        ...
        <p className="text-lg text-[#e5d3b8] leading-relaxed max-w-4xl">
          Избери маршрут според подготовката си, тръгни рано и провери прогнозата.
          Връх Ботев не е кратка разходка — носи вода, храна, връхна дреха,
          карта/GPS и план за връщане.
        </p>
      </section>
