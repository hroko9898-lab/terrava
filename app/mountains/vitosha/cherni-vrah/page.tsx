export const metadata = {
  title: "Черни връх | Маршрут във Витоша | Terrava",
  description:
    ...
    <main className="min-h-screen bg-[#f3eadb] text-[#3b2416] px-6 py-12 md:px-20 md:py-20">
      ...
      <section className="max-w-5xl mb-16">
        ...
        <p className="text-xl md:text-2xl text-[#6b4b32] leading-relaxed">
          Черни връх е първенецът на Витоша и един от най-достъпните върхове
          около София. Маршрутът от района на Алеко е популярен, сравнително
          кратък, но при мъгла, вятър или сняг не трябва да се подценява.
        </p>
      </section>
      ...
      <section className="grid md:grid-cols-4 gap-6 mb-20">
        ...
        <div className="bg-[#eadcc7] rounded-3xl p-6 border border-[#d6c3aa]">
          ...
          <p className="text-[#6b4b32]">
            С кола или градски транспорт до района на Алеко
          </p>
        </div>

        <div className="bg-[#eadcc7] rounded-3xl p-6 border border-[#d6c3aa]">
          <h2 className="text-xl font-bold mb-2">Подходящо за</h2>
          <p className="text-[#6b4b32]">Начинаещи с нормална подготовка</p>
        </div>
      </section>
      ...
      <section className="grid lg:grid-cols-2 gap-8 mb-20">
        <div className="bg-[#eadcc7] rounded-[2rem] p-8 border border-[#d6c3aa]">
          ...
          <ul className="space-y-4 text-[#6b4b32] text-lg">
            <li>Черни връх</li>
            <li>Витошкото плато</li>
            <li>Гледки към София и околните планини</li>
            <li>Леснодостъпен високопланински пейзаж</li>
          </ul>
        </div>
        ...
        <div className="bg-[#eadcc7] rounded-[2rem] p-8 border border-[#d6c3aa]">
          ...
          <ul className="space-y-4 text-[#6b4b32] text-lg">
            <li>Мъгла и силен вятър</li>
            <li>Сняг и лед извън летния сезон</li>
            <li>Открити участъци по платото</li>
            <li>Бързо влошаване на времето</li>
          </ul>
        </div>
      </section>
      ...
      <section className="bg-[#3b2416] text-[#f3eadb] rounded-[2.5rem] p-8 md:p-12 mb-20">
        ...
        <p className="text-lg text-[#e5d3b8] leading-relaxed max-w-4xl">
          Провери прогнозата и не тръгвай при силен вятър, мъгла или буря.
          Витоша е близо до града, но условията на платото могат да бъдат
          истински планински. Носи връхна дреха, вода и зареден телефон.
        </p>
      </section>
